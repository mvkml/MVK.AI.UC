...
- Dev Dashboard versions: `C:\git\v\ai_hr\hr_drive\vibe\dev_dashboard\versions\` (currently `v1` — snapshot before next round of changes)

## Project Reference Files
- Project context (auto-loaded by Claude Code): `C:\git\v\ai_hr\CLAUDE.md`
- Backlog: `C:\git\v\ai_hr\hr_agile\product_owner\backlog\BACKLOG.md`
- Roadmap: `C:\git\v\ai_hr\hr_agile\product_owner\roadmap\ROADMAP.md`
- Capability Tracker: `C:\git\v\ai_hr\hr_agile\product_owner\capability_tracker\CAPABILITY_TRACKER.md`
